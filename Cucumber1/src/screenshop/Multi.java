...
public class Multi {
	...
	public void user_should_be_able_to_succesfuly_login_to_the_application_and_close_the_application(String username) throws IOException 
	{
		try
		{
	...
	FileUtils.copyFile(sh, new File("C:\\Users\\user\\eclipse-workspace\\Cucumber1\\Sc\\image"+username+".png"));
